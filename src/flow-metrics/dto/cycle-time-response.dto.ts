...
export class CycleTimeResponseDto {
   ...
   */
  @ApiPropertyOptional({
    description: 'Mediana do cycle time (horas)',
    example: 4.5,
    nullable: true,
  })
  p50!: number | null;
   ...
   */
  @ApiPropertyOptional({
    description: '75º percentil do cycle time (horas)',
    example: 8.0,
    nullable: true,
  })
  p75!: number | null;
   ...
   */
  @ApiPropertyOptional({
    description: '90º percentil do cycle time (horas)',
    example: 16.2,
    nullable: true,
  })
  p90!: number | null;
   ...
   * `dados.telemetry.cycleTime` preenchido (status DONE).
   */
